...
// Comando exposto ao frontend: toggle always-on-top
#[tauri::command]
...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            TrayIconBuilder::new()
                ...
                .on_tray_icon_event(|tray, event| {
                    // Clique esquerdo no ícone da bandeja → mostrar/focar janela
        ...
        // Fechar janela → minimiza para bandeja (não encerra)
